...
# UI for program
    def _build_ui(self):
        ...
        self.status_label = ttk.Label(self, text="Status: starting up...", font = ("Segoe UI", 10, "italic"))
    ...
    # Mode buttons
        ...
        self.second_brain_mode_btn = ttk.Button(button_frame, text ="Second Brain", command = self.launch_second_brain_mode, width = 24)
